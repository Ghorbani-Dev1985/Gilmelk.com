...
<div className="p-2">
<Link href={`/estate/${id}`} className="block min-h-16 line-clamp-2"><h1 className="text-lg text-center mb-4 text-neutral-800">{name}</h1></Link>
<p className="flex-center gap-x-1 text-sky-500 font-bold mb-4"><HiOutlineDocumentText className="size-5"/>{categories[1].name}</p>
