    ...
    <footer className="container">
        <div className="flex flex-col items-center gap-y-10 bg-primary-200 text-white my-5 rounded-lg p-4">
          ...
          <div className="max-w-xl text-primary-700 text-justify leading-8">
            در این اپلیکشین شما می توانید ملک‌های فروشی استان گیلان با مشخصات
            کامل مشاهده نمایید. توجه داشته باشید که کلیه اطلاعات به روز هستند و
            به روزرسانی می شوند و اطلاعات ملک‌های جدید منتشر می گردند.
          </div>
          ...
          <div className="w-full flex flex-col md:flex-row md:flex-between text-primary-900 font-normal text-sm">
            ...
            <p className="dir-ltr">
              ...
              <Link href="https://github.com/Ghorbani-Dev1985" target="_blank" className="font-bold text-amber-500 mx-1">
                Ghorbani-Dev1985
              </Link>
            </p>
          </div>
